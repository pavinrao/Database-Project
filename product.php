...
<div>
   <form action="product_search.php" method = "post" class="form-inline">
    <input id ="sear" name="product_id" class="form-control mr-sm-2" type="text" placeholder="Enter product id" aria-label="Search" style="font-size: 12px;">
    <button class="btn btn-dark" type="submit" style="font-size: 12px">Search</button>
  </form>
</div>
...
$sql = "select * from Albedo.product";
