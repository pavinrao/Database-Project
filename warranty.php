...
<!-- end of nav -->
<div>
   <form action="warranty_search.php" class="form-inline">
    <input id ="sear"  name="warranty_id" class="form-control mr-sm-2" type="search" placeholder="Enter warranty id" aria-label="Search" style="font-size: 12px;">
    <button class="btn btn-dark" type="submit" style="font-size: 12px">Search</button>
  </form>
</div>
...
$sql = "select * from Albedo.warranty";
