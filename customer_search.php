...
<div>
   <form action="customer_search.php" method = "post" class="form-inline">
    <input id ="sear" name="customer_id" class="form-control mr-sm-2" type="text" placeholder="Enter repair id" aria-label="Search" style="font-size: 12px;">
    <button class="btn btn-dark" type="submit" style="font-size: 12px">Search</button>
  </form>
</div>
...
$sql = "select * from Albedo.customer where Customer_ID='$Customer_ID'";
