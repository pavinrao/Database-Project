...
<div>
   <form action="warranty_search.php" method = "post" class="form-inline">
    <input id ="sear" name="warranty_id" class="form-control mr-sm-2" type="text" placeholder="Enter repair id" aria-label="Search" style="font-size: 12px;">
    <button class="btn btn-dark" type="submit" style="font-size: 12px">Search</button>
  </form>
</div>
...
$sql = "select * from Albedo.warranty where Warranty_ID='$Warranty_ID'";
...
<?php
      while($row = $result -> fetch_assoc()){
        ...
        echo '<td>'.$row['Warranty_Type'].'</td>';
        // echo "<td><a href='edit_item.php?itemCode=".$row['Warranty_ID']."'><i class='fas fa-pen'></i>Update</a></td>";
        // echo "<td><a href='delete_item.php?itemCode=".$row['Warranty_ID']."'><i class='fas fa-trash-alt'></i>Delete</a></td>";
        echo '</tr>';
    }
    }
else{
