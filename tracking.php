...
<div>
   <form action="tracking_search.php" method = "post" class="form-inline">
    <input id ="sear" class="form-control mr-sm-2" name ="tracking_id" type="text" placeholder="Enter tracking id" aria-label="Search" style="font-size: 12px;">
    <button class="btn btn-dark" type="submit" style="font-size: 12px">Search</button>
  </form>
</div>
...
$sql = "select * from Albedo.tracking";
